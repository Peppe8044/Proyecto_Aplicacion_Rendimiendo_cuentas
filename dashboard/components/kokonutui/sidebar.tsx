          ...
          {!isAuthenticated && (
            <div className="px-4 py-4 border-t border-gray-200 dark:border-[#1F1F23]">
              <div className="space-y-1">
                <Link
                  href="/auth/login"
                  className="flex items-center px-3 py-2 text-sm rounded-md transition-colors bg-blue-600 hover:bg-blue-700 text-white"
                >
                ...
                <Link
                  href="/auth/register"
                  className="flex items-center px-3 py-2 text-sm rounded-md transition-colors text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20"
                >
